...
import { Loader2, Upload, ChevronLeft, CheckCircle, Trash2, PlusCircle } from "lucide-react";
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            <Card>
                 <CardHeader>
                    ...
                    <CardDescription>Remplissez les informations concernant votre nouveau repas.</CardDescription>
                </CardHeader>
             ...
             <Card>
                <CardHeader>
                    ...
                    <CardDescription>Entrez manuellement les macros et la liste des ingrédients.</CardDescription>
                </CardHeader>
                <CardContent>
                     <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
                        <div>
                          ...
                          {form.formState.errors.calories && <p className="text-destructive text-sm mt-1">{form.formState.errors.calories.message}</p>}
                        </div>
                        <div>
                          <Label htmlFor="protein">Protéines (g)</Label>
                          <Input id="protein" type="number" {...form.register("protein")} />
                          {form.formState.errors.protein && <p className="text-destructive text-sm mt-1">{form.formState.errors.protein.message}</p>}
                        </div>
                        <div>
                          <Label htmlFor="carbs">Glucides (g)</Label>
                          <Input id="carbs" type="number" {...form.register("carbs")} />
                          {form.formState.errors.carbs && <p className="text-destructive text-sm mt-1">{form.formState.errors.carbs.message}</p>}
                        </div>
                        <div>
                          <Label htmlFor="fat">Lipides (g)</Label>
                          <Input id="fat" type="number" {...form.register("fat")} />
                           {form.formState.errors.fat && <p className="text-destructive text-sm mt-1">{form.formState.errors.fat.message}</p>}
                        </div>
                         <div>
                          <Label htmlFor="fibers">Fibres (g)</Label>
                          <Input id="fibers" type="number" {...form.register("fibers")} />
                           {form.formState.errors.fibers && <p className="text-destructive text-sm mt-1">{form.formState.errors.fibers.message}</p>}
                        </div>
                     </div>

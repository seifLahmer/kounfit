...
import { Bell, ChevronLeft, ChevronRight, Sunrise, Sun, Moon, Cookie, Plus } from "lucide-react"
        ...
        <AccordionTrigger className="p-4 text-base hover:no-underline">
          <div className="flex items-center gap-4 w-full">
            ...
            <div className="text-left">
             ...
             <div 
              className="ml-auto flex items-center justify-center h-8 w-8 text-accent rounded-full hover:bg-accent/10"
              onClick={(e) => {
                e.stopPropagation();
      ...
      <div className="p-4 space-y-6">
        ...
        <Card>
          <CardContent className="p-4">
            <h2 className="text-lg font-bold text-center text-accent mb-2">Votre Plan Hebdomadaire</h2>
        ...
        <Card>
          <CardContent className="p-4 space-y-6">
            <h2 className="text-lg font-bold text-center text-accent">Statistiques du Jour</h2>
        ...
        <Card>
          <CardContent className="p-4">
             <h2 className="text-lg font-bold text-center text-accent mb-4">Repas de la Journée</h2>

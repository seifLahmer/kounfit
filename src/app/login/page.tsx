    ...
    async (user: FirebaseUser | CapacitorFirebaseUser) => {
      ...
      try {
        ...
        if (role === "caterer" || role === "delivery") {
          ...
          if (docSnap.exists()) {
            ...
            if (status === "rejected") {
              ...
              toast({
                title: "Accès refusé",
                description: "Votre compte a été rejeté.",
                variant: "destructive",
              });
              setIsSubmitting(false);
              return;
        ...
        toast({
          ...
          description: "Impossible de vérifier votre rôle ou votre statut.",
          variant: "destructive",
        });
        setIsSubmitting(false);
      }
  ...
  const onSubmit = async (data: LoginFormValues) => {
    ...
    try {
      ...
      if (
        ...
        description =
          "L'adresse e-mail ou le mot de passe est incorrect. Veuillez vérifier vos informations.";
      }
      toast({
      ...
      <div className="w-full max-w-sm mx-auto px-4 py-4 flex-1">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                  ...
                  <FormControl>
                    <div className="relative">
                      ...
                      <Input
                        ...
                        {...field}
                        className="pl-12 h-14 rounded-full border-gray-200"
                      />
                    </div>
                  </FormControl>
                  <FormMessage />
            ...
            <Button
              type="submit"
              className="w-full h-14 text-lg font-semibold rounded-full bg-primary hover:bg-primary/90 text-white"
